...
class MedicationCleanup {
  static Future<int> cleanupOldMedicationEvents() async {
    ...
    print('Found ${snapshot.docs.length} old medication events to delete');
    ...
    for (final doc in snapshot.docs) {
      ...
      if (deletedCount % 400 == 0) {
        await batch.commit();
        print('Deleted $deletedCount medication events so far...');
      }
    }
    ...
    print('Successfully deleted $deletedCount old medication events');
    return deletedCount;
  }
  ...
  static Future<int> cleanupNewMedications() async {
    ...
    print('Successfully deleted $totalDeleted medications from new system');
    return totalDeleted;
  }
  ...
  static Future<Map<String, int>> cleanupAll() async {
    ...
    return {
      'oldMedicationEvents': oldCount,
      'newMedications': newCount,
    };
  }
}
